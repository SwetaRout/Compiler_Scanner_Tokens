...
Apart from what is mentioned below, I would like to add an error existing in the code. The single line comments starting with "//" are not recognised as meta statements as per the given code.
So, the output is not as per requirement if the code contains such statements
